(async() => {
    ...
    if (["RadioChoicePopup", "BrowserTab", "PageProperty", "ListofObj_Base", "ListofObj_to_Table", "ListofObj_to_DelimitedText"]
        ...
        /**
         * Converts XPath objects to List of Objects
         *
         * @param {Object} objXPathCollection - XPath object
         * @returns {Array} - List of Objects array
         */
    ...
    `;
        ...
        const popup = new RadioChoicePopup({
            title: "Method of Web Scraping",
            message: "Select the method of web scraping:",
            options: [{
                    label: "CSS Selector",
                    value: "CSS"
                }, {
        ...
        const webscrape_choice = await popup.show();
        var webscrape_string = "";
        if (webscrape_choice === "CSS") {

            var cssSelectorwebscrape = prompt(
                    "Enter CSS selector for web scraping (default:A): ",
                    "A");

            listofObject = document.querySelectorAll(cssSelectorwebscrape);
            tableschema = {
                "Extracted innerText": "innerText",
                "Extracted outerHTML": "outerHTML",
                "CSS selector attributes": "attributes"
            };
            webscrape_string = cssSelectorwebscrape;

        } else if (webscrape_choice === "XPath") {
            ...
            let objXPathCollection = document.evaluate(
                    ...
                    null); // define the DOM object as HTML Collections
            listofObject = convertXPathObj_to_listofObjArr(objXPathCollection);
            tableschema = {
                "Extracted Text": "textContent",
                "outerHTML": "outerHTML",
            };
            webscrape_string = xPathwebscrape;
